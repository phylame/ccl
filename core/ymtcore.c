...
static void _ycls_destroy_(yobject self);
...
yclass ycls_for_yclass(void)
{
    if(nil == _ycls_meta_) {
        ...
        _ycls_meta_->_destroy_ = _ycls_destroy_;
    }
    return _ycls_meta_;
}
...
{
    yobj_not_nil(self);
    YD_FORWARD_METHOD(self, _hash_, _invoke_hash_);
...
ybool yobj_equals(yobject self, yobject other)
{
    ...
    YD_FORWARD_METHOD(self, _equal_, _invoke_equal_, other);
...
{
    yobj_not_nil(self);
    YD_FORWARD_METHOD(self, _string_, _invoke_string_);
...
yobject yobj_release(yobject self)
{
    if(yobj_is_nil(self)) {
        ...
        YD_FORWARD_METHOD(self, _destroy_, _invoke_destroy_);
