...
#define _MAKE_VALUE_(_type, field, _value)                   \
    yvalue self = Y_ALLOC_OBJECT(yvalue, ycls_for_yvalue()); \
    if(self != nil) {                                        \
        self->type = _type;                                  \
